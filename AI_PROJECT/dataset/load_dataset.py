...
def get_torch_dataloader(dataset_path="data_generator/img", not_background = True):
    ...
    valid_set_obj = CustomBBoxDataset(valid_set, "test")
    test_set_obj = CustomBBoxDataset(test_set, split="test")
